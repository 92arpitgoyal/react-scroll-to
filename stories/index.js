...
storiesOf("ScrollTo", module)
      ...
      <ScrollTo>
        {({ scrollTo }) => (
          <React.Fragment>
            <button
              style={{ padding: 20 }}
              onClick={() => scrollTo({ y: 500, duration: 1000 })}
            >
              Scroll Down!
            </button>
            ...
            <button
              ...
              onClick={() => scrollTo({ duration: 1000 })}
            >
              Scroll Up!
            </button>
          </React.Fragment>
      ...
      <ScrollTo>
        {({ scrollTo }) => (
          <React.Fragment>
            <button
              style={{ padding: 5 }}
              onClick={() => scrollTo({ x: 0, y: 1000, duration: 500 })}
            >
              Scroll area down
            </button>
  ...
  .add("higher order component", () => {
    const YButton = ScrollToHOC(props => (
      <button
        onClick={() => props.scrollTo({ x: 0, y: props.y || 0, duration: 200 })}
        style={props.style}
      >
        {props.children}
      </button>
    ...
    return (
      <div style={{ height: "2000px", position: "relative" }}>
        ...
        <YButton style={{ position: "absolute", bottom: 0, left: 0 }}>
          top
        </YButton>
      </div>
    );
